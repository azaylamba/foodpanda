...
You have to design & build the backend for the application and the ability for the users to register, find restaurants, order food etc.
...
https://github.com/azaylamba/foodpanda 
